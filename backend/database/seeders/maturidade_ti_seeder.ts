...
/**
 * Seeder for the "Maturidade de TI" survey.
 *
 ...
 */
export default class MaturidadeTiSeeder extends BaseSeeder {
  async run() {
  ...
  private async seedCascadeRules(questions: Question[]): Promise<void> {
    ...
    // SG-01: if answer is "c" or "d", skip SG-01a → go to SG-02
  ...
  // ---------------------------------------------------------------------------
  // Score Ranges — 5 maturity levels
  // ---------------------------------------------------------------------------
